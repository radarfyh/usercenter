...
public class UserOrderController extends BaseController{
	...
	@DubboReference
	private IUserTargetPrizeService orderService;
	...
	public ResultResponse<RespUserTargetPrizeInfo> userTargetPrizeInfo() throws Exception {
		return ResultResponseEnum.QUERY_SUCCESS.resultResponse(orderService.userTargetPrizeInfo(getUserId()));
	}
	...
	public ResultResponse<?> saveUserTargetProze(@Valid @RequestBody ReqSaveUserTargetPrize req) throws Exception {
		orderService.saveUserTargetProze(getUserId(), req);
	...
	public ResultResponse<BigDecimal> prizeCompletion() throws Exception {
		return ResultResponseEnum.QUERY_SUCCESS.resultResponse(orderService.prizeCompletion(getUserId()));
	}
